...
- Twenty-two playable myths with fully English UI and story text
...
- Twenty-two monoscopic 360° scenes rendered from inside a WebGL sphere
...
The twenty-two game textures in `public/assets/` are 4096×2048 WebP files. They cover 360° horizontally and 180° vertically, keep the horizon near the middle, and are mapped to the inside of a Three.js sphere with the camera at its centre.
