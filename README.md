...
- Fifty playable myths, including the Ganymedes tradition on Mount Ida and a six-scene route through Heracles’ ninth labour from Mycenae to Themiskyra and Troy
...
- Fifty monoscopic 360° scenes rendered from inside a WebGL sphere
- Optional looping background music that starts after the first browser-approved interaction, with a persistent bilingual mute control
