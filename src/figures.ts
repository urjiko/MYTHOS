...
export const figureProfiles: FigureProfile[] = [
  ...
  },
  {
    ...
    appearanceIds: ['telephus-achilles', 'patroclus-falls', 'achilles-hector', 'priam-achilles'],
  ...
  },
  {
    ...
    appearanceIds: ['lernaean-hydra', 'hippolyta-girdle'],
  ...
  },
  {
    id: 'arachne',
    category: 'heroes',
    name: { en: 'Arachne', tr: 'Arachne' },
    epithet: { en: 'The weaver of Hypaipa', tr: 'Hypaipalı dokumacı' },
    summary: {
      en: 'A Lydian artisan whose confidence in her craft leads to a contest with Athena. Her tapestry is technically faultless and daring in its criticism of divine power.',
      tr: 'Ustalığına duyduğu güven onu Athena’yla yarışmaya götüren Lydialı sanatçı. Dokuması teknik açıdan kusursuz, tanrısal güce yönelttiği eleştiride ise cesurdur.',
    },
    facts: [
      { en: 'Home: Hypaipa in Lydia', tr: 'Yurdu: Lydia’daki Hypaipa' },
      { en: 'Craft: weaving and tapestry', tr: 'Sanatı: dokuma ve duvar halısı' },
      { en: 'Her name becomes inseparable from the spider.', tr: 'Adı örümcekle ayrılmaz biçimde özdeşleşir.' },
    ],
    appearanceIds: ['arachne-athena'],
    image: './assets/scene-arachne-athena.webp',
    objectPosition: '27% center',
    externalUrl: 'https://www.theoi.com/Heros/Arakhne.html',
    externalSite: 'Theoi Project',
  },
  {
    id: 'hermaphroditus',
    category: 'heroes',
    name: { en: 'Hermaphroditus', tr: 'Hermaphroditos' },
    epithet: { en: 'Child of Hermes and Aphrodite', tr: 'Hermes ile Aphrodite’nin çocuğu' },
    summary: {
      en: 'A youthful child of Hermes and Aphrodite whose encounter with Salmacis becomes Ovid’s explanation for a body combining female and male traits.',
      tr: 'Salmakis’le karşılaşması Ovidius’ta kadın ve erkek özelliklerini birleştiren bedenin köken anlatısına dönüşen Hermes ile Aphrodite’nin genç çocuğu.',
    },
    facts: [
      { en: 'Parents: Hermes and Aphrodite', tr: 'Anne-babası: Hermes ve Aphrodite' },
      { en: 'Setting: the Salmacis spring at Halicarnassus', tr: 'Mekân: Halikarnassos’taki Salmakis Pınarı' },
      { en: 'The ancient story does not describe a mutually chosen union.', tr: 'Antik anlatı karşılıklı seçilmiş bir birleşmeyi anlatmaz.' },
    ],
    appearanceIds: ['salmacis-hermaphroditus'],
    image: './assets/scene-salmacis-hermaphroditus.webp',
    objectPosition: '21% center',
    externalUrl: 'https://www.theoi.com/Ouranios/ErosHermaphroditos.html',
    externalSite: 'Theoi Project',
  },
  {
    id: 'hero',
    category: 'heroes',
    name: { en: 'Hero', tr: 'Hero' },
    epithet: { en: 'The lamp-keeper of Sestos', tr: 'Sestos’un kandil bekçisi' },
    summary: {
      en: 'A priestess of Aphrodite at Sestos whose lamp guides Leander across the Hellespont. The fragile beacon makes love, distance, and weather part of one tragic geography.',
      tr: 'Kandili Leandros’a Hellespontos boyunca yol gösteren Sestoslu Aphrodite rahibesi. Kırılgan ışık; aşkı, mesafeyi ve havayı tek bir trajik coğrafyada birleştirir.',
    },
    facts: [
      { en: 'City: Sestos on the European shore', tr: 'Kenti: Avrupa kıyısındaki Sestos' },
      { en: 'Signal: an oil lamp in a tower', tr: 'İşareti: kuledeki yağ kandili' },
      { en: 'Ancient tellings pair her letters with Leander’s.', tr: 'Antik anlatılar onun mektuplarını Leandros’unkilerle eşleştirir.' },
    ],
    appearanceIds: ['hero-leander'],
    image: './assets/scene-hero-leander.webp',
    objectPosition: '21% center',
    externalUrl: 'https://www.britannica.com/topic/Hero-and-Leander',
    externalSite: 'Encyclopaedia Britannica',
  },
  {
    id: 'leander',
    category: 'heroes',
    name: { en: 'Leander', tr: 'Leandros' },
    epithet: { en: 'The swimmer of Abydos', tr: 'Abydoslu yüzücü' },
    summary: {
      en: 'A young man of Abydos who repeatedly swims the Hellespont at night, steering toward Hero’s lamp until winter weather erases the signal.',
      tr: 'Hero’nun kandiline yönelerek Hellespontos’u geceleri defalarca yüzen Abydoslu genç. Kış fırtınası yol gösteren ışığı sonunda yok eder.',
    },
    facts: [
      { en: 'City: Abydos on the Anatolian shore', tr: 'Kenti: Anadolu kıyısındaki Abydos' },
      { en: 'Route: the narrows of the Hellespont', tr: 'Rotası: Hellespontos’un dar geçidi' },
      { en: 'His feat has inspired later cross-strait swims.', tr: 'Başarısı sonraki boğaz yüzüşlerine ilham vermiştir.' },
    ],
    appearanceIds: ['hero-leander'],
    image: './assets/scene-hero-leander.webp',
    objectPosition: '57% center',
  ...
  },
  {
    id: 'hippolyta',
    category: 'heroes',
    name: { en: 'Hippolyta', tr: 'Hippolyta' },
    epithet: { en: 'Queen of the Amazons', tr: 'Amazonların kraliçesi' },
    summary: {
      en: 'An Amazon queen whose war belt, a gift from Ares, becomes the object of Heracles’ ninth labour. In Apollodorus, she first chooses peaceful exchange before Hera intervenes.',
      tr: 'Ares’in armağanı olan savaş kuşağı Herakles’in dokuzuncu görevine dönüşen Amazon kraliçesi. Apollodoros’ta Hera araya girmeden önce barışçıl değişimi kendisi seçer.',
    },
    facts: [
      { en: 'Father: Ares', tr: 'Babası: Ares' },
      { en: 'Emblem of rule: the war belt', tr: 'Hükümdarlık simgesi: savaş kuşağı' },
      { en: 'Ancient versions disagree about her fate.', tr: 'Antik anlatılar onun kaderinde ayrılır.' },
    ],
    appearanceIds: ['hippolyta-girdle'],
    image: './assets/scene-hippolyta-girdle.webp',
    objectPosition: '25% center',
    externalUrl: 'https://www.theoi.com/Heroine/AmazonHippolyte.html',
    externalSite: 'Theoi Project',
  },
  {
    id: 'telephus',
    category: 'heroes',
    name: { en: 'Telephus', tr: 'Telephos' },
    epithet: { en: 'The Mysian king on the road to Troy', tr: 'Troya yolundaki Mysia kralı' },
    summary: {
      en: 'A son of Heracles who becomes king in Mysia. When the Achaeans mistake his country for Troy, he resists them, is wounded by Achilles, and later becomes the guide they need.',
      tr: 'Mysia’da kral olan Herakles oğlu. Akhalar ülkesini Troya sanınca onlara direnir, Akhilleus tarafından yaralanır ve daha sonra ihtiyaç duydukları rehbere dönüşür.',
    },
    facts: [
      { en: 'Parents: Heracles and Auge', tr: 'Anne-babası: Herakles ve Auge' },
      { en: 'Kingdom: Teuthrania in Mysia', tr: 'Krallığı: Mysia’daki Teuthrania' },
      { en: 'The weapon that wounds him also provides his cure.', tr: 'Onu yaralayan silah iyileşmesini de sağlar.' },
    ],
    appearanceIds: ['telephus-achilles'],
    image: './assets/scene-telephus-achilles.webp',
    objectPosition: '76% center',
    externalUrl: 'https://en.wikipedia.org/wiki/Telephus',
    externalSite: 'Wikipedia',
  },
  {
    id: 'attis',
    category: 'heroes',
    name: { en: 'Attis', tr: 'Attis' },
    epithet: { en: 'The remembered youth of Pessinus', tr: 'Pessinus’un hatırlanan genci' },
    summary: {
      en: 'A Phrygian youth bound to the Great Mother’s cult at Pessinus. Ancient versions turn his wedding, loss, and preservation into a difficult story of divine power and enduring memory.',
      tr: 'Pessinus’taki Büyük Ana kültüne bağlı Phrygialı genç. Antik anlatılar onun düğününü, kaybını ve korunmasını tanrısal güç ile kalıcı hafızanın zor bir öyküsüne dönüştürür.',
    },
    facts: [
      { en: 'Cult centre: Pessinus in Phrygia', tr: 'Kült merkezi: Phrygia’daki Pessinus' },
      { en: 'Sacred emblem: the evergreen pine', tr: 'Kutsal simgesi: herdem yeşil çam' },
      { en: 'Greek and Roman versions disagree sharply.', tr: 'Yunan ve Roma anlatıları önemli ölçüde ayrılır.' },
    ],
    appearanceIds: ['attis-great-mother'],
    image: './assets/scene-attis-great-mother.webp',
    objectPosition: '17% center',
    externalUrl: 'https://en.wikipedia.org/wiki/Attis',
    externalSite: 'Wikipedia',
  },
  {
    id: 'io',
    category: 'heroes',
    name: { en: 'Io', tr: 'Io' },
    epithet: { en: 'The horned wanderer', tr: 'Boynuzlu gezgin' },
    summary: {
      en: 'An Argive princess and priestess pursued across the ancient world in cow-shaped form. Her flight crosses the Bosporus and links Greek landscapes with an eventual arrival in Egypt.',
      tr: 'İnek biçiminde antik dünyada kovalanan Argoslu prenses ve rahibe. Kaçışı Bosporos’u aşar; Yunan coğrafyasını Mısır’a varan uzun bir yolculuğa bağlar.',
    },
    facts: [
      { en: 'Origin: Argos', tr: 'Kökeni: Argos' },
      { en: 'Pursuer: Hera’s gadfly', tr: 'Takipçisi: Hera’nın at sineği' },
      { en: 'Her descendants include Epaphus and, eventually, Heracles.', tr: 'Soyundan Epaphos ve sonunda Herakles gelir.' },
    ],
    appearanceIds: ['io-flight'],
    image: './assets/scene-io-flight.webp',
    objectPosition: '16% center',
    externalUrl: 'https://www.theoi.com/Heroine/Io.html',
    externalSite: 'Theoi Project',
  },
  {
    id: 'salmacis',
    category: 'creatures',
    name: { en: 'Salmacis', tr: 'Salmakis' },
    epithet: { en: 'Naiad of the Carian spring', tr: 'Karia pınarının naiadesi' },
    summary: {
      en: 'The naiad attached to a spring at Halicarnassus. Ovid makes her pursuit and binding prayer central to the metamorphosis of Hermaphroditus.',
      tr: 'Halikarnassos’taki bir pınara bağlı naias. Ovidius, onun takibini ve bağlayıcı dileğini Hermaphroditos’un dönüşümünün merkezine yerleştirir.',
    },
    facts: [
      { en: 'Landscape: a spring at Halicarnassus', tr: 'Coğrafyası: Halikarnassos’taki bir pınar' },
      { en: 'Type: naiad, a freshwater nymph', tr: 'Türü: naias, tatlı su nymphesi' },
      { en: 'Strabo records a more sober local account of the spring.', tr: 'Strabon pınar hakkında daha ölçülü bir yerel anlatı aktarır.' },
    ],
    appearanceIds: ['salmacis-hermaphroditus'],
    image: './assets/scene-salmacis-hermaphroditus.webp',
    objectPosition: '51% center',
    externalUrl: 'https://www.theoi.com/Nymphe/NympheSalmakis.html',
    externalSite: 'Theoi Project',
  },
]
